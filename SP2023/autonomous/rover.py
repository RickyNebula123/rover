...
class rover:
    ...
    def __init__(self):
        ...
        self.streaming_thread_event= threading.Event() # Camera event
        self.static_thread_event= threading.Event()    # Sensor event
        ...
        # Initialize camera
        self.camera = cam.Camera(self.streaming_thread_event, self.ip, self.camera_port) # Create camera instance
    ...
    def initialize_motors(self):       
        ...
        self.front_right_motor = motor.Motor(pins.DUTYCYCLE_FR, pins.MOTOR_FRONT_RIGHT_A, pins.MOTOR_FRONT_RIGHT_B)
        self.front_left_motor  = motor.Motor(pins.DUTYCYCLE_FL, pins.MOTOR_FRONT_LEFT_A,  pins.MOTOR_FRONT_LEFT_B)
        self.back_right_motor  = motor.Motor(pins.DUTYCYCLE_BR, pins.MOTOR_BACK_RIGHT_A,  pins.MOTOR_BACK_RIGHT_B)
        self.back_left_motor   = motor.Motor(pins.DUTYCYCLE_BL, pins.MOTOR_BACK_LEFT_A,   pins.MOTOR_BACK_LEFT_B)
